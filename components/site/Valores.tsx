...
const ICONES: Record<string, React.ReactNode> = {
  ...
  // ── ANA ──────────────────────────────────────────────────────
  // ⚠️ ÍCONES ACRESCENTADOS NO MOTOR, e o motivo é que nenhum dos
  //    anteriores diz as causas dela: não há pata, nem cuidado, nem
  //    criança. Pôr "familia" na causa animal seria o cartão dizendo
  //    uma coisa e o ícone outra. Chave nova não quebra chave antiga.

  // O mesmo escudo com estrela de `armas`, com nome de gente: aqui ele
  // é o distintivo, não o direito de se proteger.
  policia: (
    <path d="M12 2 4 5.5V11c0 5.2 3.4 9.9 8 11 4.6-1.1 8-5.8 8-11V5.5L12 2Zm0 4.6 1.5 3.1 3.4.5-2.5 2.4.6 3.4-3-1.6-3 1.6.6-3.4L7.1 10.2l3.4-.5L12 6.6Z" />
  ),
  // Coração com a cruz vazada: cuidado, e não "amor". `evenodd` é o
  // que abre a cruz dentro do coração.
  'saude-mental': (
    <path
      fillRule="evenodd"
      d="M12 20.6 4.4 13.1A4.75 4.75 0 0 1 11.1 6.4l.9.9.9-.9a4.75 4.75 0 0 1 6.7 6.7L12 20.6Zm-1-10.1v2H9v2h2v2h2v-2h2v-2h-2v-2h-2Z"
    />
  ),
  animal: (
    <path d="M5.5 8a2 2 0 1 0 0 4 2 2 0 1 0 0-4Zm4-4a2 2 0 1 0 0 4 2 2 0 1 0 0-4Zm5 0a2 2 0 1 0 0 4 2 2 0 1 0 0-4Zm4 4a2 2 0 1 0 0 4 2 2 0 1 0 0-4ZM12 12c-2.8 0-5.5 3-5.5 5.2 0 1.6 1.3 2.6 2.9 2.6 1 0 1.7-.5 2.6-.5s1.6.5 2.6.5c1.6 0 2.9-1 2.9-2.6 0-2.2-2.7-5.2-5.5-5.2Z" />
  ),
  infancia: (
    <path d="M12 2.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 1 0 0-5ZM8.2 9h7.6l3.2 4.2-1.6 1.2-2.4-2.8V14l1.5 7h-2.8L12 16.5 10.3 21H7.5L9 14v-2.4l-2.4 2.8L5 13.2 8.2 9Z" />
  ),
}
