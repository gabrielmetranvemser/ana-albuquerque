 ...
 *
 * ⚠️ ANA: SEM CARTÃO. Era um cartão azul de canto arredondado dentro da
 *    seção branca, e a campanha: "achei feio todos os blocos que tem". Não
 *    virou faixa azul de ponta a ponta porque fica entre o filtro e o
 *    rodapé, os dois escuros — três faixas escuras seguidas pesavam. Fica
 *    direto sobre o papel quadriculado, com o botão laranja.
 */
      ...
      <div className="grid gap-10 lg:grid-cols-[1fr_auto] lg:items-center">
        ...
        <div data-revelar className="flex flex-col gap-3 sm:flex-row lg:flex-col">
          <a
            ...
            className="inline-flex min-h-14 items-center justify-center gap-2.5 rounded-full bg-amarelo px-8 text-lg font-semibold text-azul-escuro shadow-[0_16px_30px_-18px_rgba(242,90,18,0.9)] transition-all duration-300 hover:brightness-105"
          >
          ...
          <Botao variante="contorno" tamanho="lg" onClick={compartilharNativo} className="text-azul">
