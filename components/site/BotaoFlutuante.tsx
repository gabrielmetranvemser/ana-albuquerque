  ...
  return (
    ...
    >
      <Link
        ...
        className="toque flex min-h-14 w-full items-center justify-center gap-3 rounded-full bg-amarelo px-7 font-semibold text-azul-escuro shadow-alta transition-all duration-300 hover:brightness-110 md:w-auto"
      >
