...
export const ESQUEMA: Record<string, SecaoEsquema> = {
  ...
  rua: {
    rotulo: 'A rua',
    grupo: 'Página',
    // ANA: os rótulos falavam de pandemia e de 2020 — a história da
    // primeira campanha que usou este modelo. Para a Ana a seção é a
    // linha de frente, e rótulo que fala de outra coisa confunde quem
    // edita.
    nota: '⚠️ Confira quem aparece nas fotos além da Ana: pessoa de terceiros exige autorização de uso.',
    campos: {
      etiqueta: { tipo: 'texto', rotulo: 'Etiqueta', max: 40, ajuda: 'Ex.: Na linha de frente' },
      titulo: { tipo: 'texto', rotulo: 'Título', max: 70, destaque: true },
      texto: { tipo: 'longo', rotulo: 'Texto', max: 300, linhas: 3 },
      video: videoSolto(
        'Vídeo da linha de frente',
        'Seção "Na linha de frente" — logo abaixo do texto de abertura e ANTES das três fotos.',
      ...
      itens: {
        ...
        item: {
          ...
          chave: {
            ...
            max: 20,
            ajuda:
              'familia · liberdade · segurança · lei · armas · producao · imposto · fe · ' +
              'policia · saude-mental · animal · infancia',
          },
  ...
  candidato: {
    ...
    campos: {
      ...
      // 15, e não 10: a sigla da Ana é SOLIDARIEDADE (13). Com 10,
      // salvar esta tela recusaria a sigla verdadeira do partido.
      partido: { tipo: 'texto', rotulo: 'Sigla do partido', max: 15 },
