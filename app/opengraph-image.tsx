...
async function paraJpeg(bytes: Buffer): Promise<Buffer> {
  return sharp(bytes)
    ...
    .flatten({ background: campanha.cores.noite })
    ...
    (
      <div
        style={{
          ...
          // ⚠️ ANA: as cores deste cartão eram hex fixos da primeira
          //    campanha (azul, verde e amarelo dela). Agora saem da
          //    paleta, como o resto do site.
          background: `linear-gradient(135deg, ${campanha.cores.noite} 0%, ${campanha.cores.primaria} 100%)`,
          padding: 72,
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          <div
            style={{
              ...
              height: 12,
              borderRadius: 999,
              background: campanha.cores.secundaria,
            }}
          />
          <div style={{ fontSize: 26, color: campanha.cores.acao, letterSpacing: 2, fontWeight: 600 }}>
          ...
          >
            <div
              style={{
                ...
                justifyContent: 'center',
                background: '#ffffff',
                color: campanha.cores.primariaEscura,
                fontSize: 76,
                fontWeight: 800,
                letterSpacing: -4,
                padding: '10px 32px',
